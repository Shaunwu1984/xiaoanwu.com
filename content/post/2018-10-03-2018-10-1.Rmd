...
首先指出，一般而言，在这个世界中的演化规则似乎把完备的$3 \times 3$占有形式和 中心方格的后继状态联系在一起。如果中心底层位置的状态从来没有和演化相关，那么对于它的因果效应就应该没有任何可以争议的地方。想象图10的情形，C总是伴随着被占据的中心方格，D总是伴随着空的中心方格。



![](/post/2018-10-03-2018-10-1_files/2.png){width=400px}

512个转换规则的完备集合是如此错综多样，以至于除了把这512个规则分别一一说明之外不存在一个更为紧致有效表达它们的方式。试图把形式A和形式B捆绑为一条规则并不会是的情形简单很多，因为我们将不得不说明，不管是暗含地还是确切地说明，在这个情形中，底层中心方格的状态无需确定，尽管在其他情形中它是需要确定的。
